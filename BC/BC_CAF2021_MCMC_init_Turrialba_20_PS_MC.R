## BC_CAF2021_MCMC_init_Turrialba_20_PS_MC.R
## MvO, 2021-03-19

## FILE FOR PRIOR PARAMETER DISTRIBUTION
   file_prior <- "parameters/parameters_BC_Turrialba_19-20_PS.txt"
...
## SETTINGS FOR THE DIFFERENT CALIBRATION SITES (at least one site)
   ...
   sitedata_filenames     <- "data/data_Turrialba_20_PS_MC.txt"
