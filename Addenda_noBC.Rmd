...
```{r, eval=F}
  file_parModes <- "CAF2021_parModes_06_45.txt"
  ...
  # summary(         df_parModes[,iCV]   )
  # summary( unlist( df_parModes[,iCV] ) )
...
```{r, eval=F}
  # load( "df_C.f_final_exceptYieldConv3.rda" )
  # load( "df_G.f_final_exceptYieldConv3.rda" )
  # 
  # df_C.f <- df_C.f %>% 
  #   mutate( yield1819 = yield1819 * 3.87/3) %>%
  #   mutate( yield1920 = yield1920 * 3.87/3)
  # 
  # df_G.f <- df_G.f %>% 
  #   mutate( yield1819 = yield1819 * 3.87/3) %>%
  #   mutate( yield1920 = yield1920 * 3.87/3)
