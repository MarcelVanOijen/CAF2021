...
## 4. PARAMETERISATION AND MANAGEMENT ##
   ...
   calendar_thinT[ 3,  1, ] <- c( 2007,  75, 0.26 )
   calendar_thinT[ 3,  2, ] <- c( 2008,  74, 0.18 )
   calendar_thinT[ 3,  3, ] <- c( 2009,  89, 0.27 )
   calendar_thinT[ 3,  4, ] <- c( 2011,  75, 0.31 )
   calendar_thinT[ 3,  5, ] <- c( 2012,  75, 0.16 )
   calendar_thinT[ 3,  6, ] <- c( 2013,  80, 0.05 )
