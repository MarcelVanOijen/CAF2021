...
## 4. PARAMETERISATION AND MANAGEMENT ##
   ...
   calendar_thinT[   1, ] <- c( 2007,  43, 0.25 )
   calendar_thinT[   2, ] <- c( 2008,  72, 0.35 )
   calendar_thinT[   3, ] <- c( 2009,  89, 0.28 )
   calendar_thinT[   4, ] <- c( 2011,  75, 0.24 )
   calendar_thinT[   5, ] <- c( 2012,  80, 0.25 )
