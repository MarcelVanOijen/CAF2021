...
```{r, fig.height=8}
  alt_C.f.Obs <- df_typol_C.f$altitude
  y_C.f.Obs   <- df_typol_C.f$yield
  
  par( mfrow=c(2,2) )
  
  ymax <- max( df_typol_C.f$yield, df_typol_G.f$yield )
  plot  ( df_typol_C.f$altitude, df_typol_C.f$yield, main="yield",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_typol_G.f$altitude, df_typol_G.f$yield,
          col="red", pch=20 )
  y_C.lm <- lm( df_typol_C.f$yield ~ df_typol_C.f$altitude )
  y_G.lm <- lm( df_typol_G.f$yield ~ df_typol_G.f$altitude )
  ...
  ymax <- max( df_typol_C.f$nt, df_typol_G.f$nt )
  plot  ( df_typol_C.f$altitude, df_typol_C.f$nt, main="# tree spp.",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_typol_G.f$altitude, df_typol_G.f$nt,
          col="red", pch=20 )
  y_C.lm <- lm( df_typol_C.f$nt ~ df_typol_C.f$altitude )
  y_G.lm <- lm( df_typol_G.f$nt ~ df_typol_G.f$altitude )
  r2_C   <- round( summary(y_C.lm)$r.squared, 2 )
  r2_G   <- round( summary(y_G.lm)$r.squared, 2 )
  abline( y_C.lm$coefficients[1], y_C.lm$coefficients[2], col="black" )
  abline( y_G.lm$coefficients[1], y_G.lm$coefficients[2], col="red"   )
  ...
  ymax <- max( df_typol_C.f$shade, df_typol_G.f$shade )
  plot  ( df_typol_C.f$altitude, df_typol_C.f$shade, main="shade",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_typol_G.f$altitude, df_typol_G.f$shade,
          col="red", pch=20 )
  y_C.lm <- lm( df_typol_C.f$shade ~ df_typol_C.f$altitude )
  y_G.lm <- lm( df_typol_G.f$shade ~ df_typol_G.f$altitude )
  r2_C   <- round( summary(y_C.lm)$r.squared, 2 )
  r2_G   <- round( summary(y_G.lm)$r.squared, 2 )
  abline( y_C.lm$coefficients[1], y_C.lm$coefficients[2], col="black" )
  abline( y_G.lm$coefficients[1], y_G.lm$coefficients[2], col="red"   )
  ...
  ymax <- max( df_typol_C.f$Nfert, df_typol_G.f$Nfert )
  plot  ( df_typol_C.f$altitude, df_typol_C.f$Nfert, main="Nfert",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_typol_G.f$altitude, df_typol_G.f$Nfert,
          col="red", pch=20 )
  y_C.lm <- lm( df_typol_C.f$Nfert ~ df_typol_C.f$altitude )
  y_G.lm <- lm( df_typol_G.f$Nfert ~ df_typol_G.f$altitude )
  r2_C   <- round( summary(y_C.lm)$r.squared, 2 )
  r2_G   <- round( summary(y_G.lm)$r.squared, 2 )
  abline( y_C.lm$coefficients[1], y_C.lm$coefficients[2], col="black" )
  abline( y_G.lm$coefficients[1], y_G.lm$coefficients[2], col="red"   )
...
```{r, fig.height=8}
  ...
  ymax <- max( df_soil_C.f$DMfrac.soil, df_soil_G.f$DMfrac.soil )
  plot  ( df_soil_C.f$altitude, df_soil_C.f$DMfrac.soil, main="DM (g cm-3)",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_soil_G.f$altitude, df_soil_G.f$DMfrac.soil,
          col="red", pch=20 )
  y_C.lm <- lm( df_soil_C.f$DMfrac.soil ~ df_soil_C.f$altitude )
  y_G.lm <- lm( df_soil_G.f$DMfrac.soil ~ df_soil_G.f$altitude )
  r2_C   <- round( summary(y_C.lm)$r.squared, 2 )
  r2_G   <- round( summary(y_G.lm)$r.squared, 2 )
  abline( y_C.lm$coefficients[1], y_C.lm$coefficients[2], col="black" )
  abline( y_G.lm$coefficients[1], y_G.lm$coefficients[2], col="red"   )
  ...
  ymax <- max( df_soil_C.f$CN.soil, df_soil_G.f$CN.soil )
  plot  ( df_soil_C.f$altitude, df_soil_C.f$CN.soil, main="C/N (-)",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_soil_G.f$altitude, df_soil_G.f$CN.soil,
          col="red", pch=20 )
  y_C.lm <- lm( df_soil_C.f$CN.soil ~ df_soil_C.f$altitude )
  y_G.lm <- lm( df_soil_G.f$CN.soil ~ df_soil_G.f$altitude )
  r2_C   <- round( summary(y_C.lm)$r.squared, 2 )
  r2_G   <- round( summary(y_G.lm)$r.squared, 2 )
  abline( y_C.lm$coefficients[1], y_C.lm$coefficients[2], col="black" )
  abline( y_G.lm$coefficients[1], y_G.lm$coefficients[2], col="red"   )
  ...
  ymax <- max( df_soil_C.f$C.soil, df_soil_G.f$C.soil )
  plot  ( df_soil_C.f$altitude, df_soil_C.f$C.soil, main="Carbon (kg C m-2)",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_soil_G.f$altitude, df_soil_G.f$C.soil,
          col="red", pch=20 )
  y_C.lm <- lm( df_soil_C.f$C.soil ~ df_soil_C.f$altitude )
  y_G.lm <- lm( df_soil_G.f$C.soil ~ df_soil_G.f$altitude )
  r2_C   <- round( summary(y_C.lm)$r.squared, 2 )
  r2_G   <- round( summary(y_G.lm)$r.squared, 2 )
  abline( y_C.lm$coefficients[1], y_C.lm$coefficients[2], col="black" )
  abline( y_G.lm$coefficients[1], y_G.lm$coefficients[2], col="red"   )
  ...
  ymax <- max( df_soil_C.f$N.soil, df_soil_G.f$N.soil )
  plot  ( df_soil_C.f$altitude, df_soil_C.f$N.soil, main="Nitrogen (kg N m-2)",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_soil_G.f$altitude, df_soil_G.f$N.soil,
          col="red", pch=20 )
  y_C.lm <- lm( df_soil_C.f$N.soil ~ df_soil_C.f$altitude )
  y_G.lm <- lm( df_soil_G.f$N.soil ~ df_soil_G.f$altitude )
  r2_C   <- round( summary(y_C.lm)$r.squared, 2 )
  r2_G   <- round( summary(y_G.lm)$r.squared, 2 )
  abline( y_C.lm$coefficients[1], y_C.lm$coefficients[2], col="black" )
  abline( y_G.lm$coefficients[1], y_G.lm$coefficients[2], col="red"   )
...
# Combining all data for CAF2021 in one R-dataframe 

```{r}
  df_C.f <- df_coords_C.f %>% mutate( weather = weather_C.f )
  df_G.f <- df_coords_G.f %>% mutate( weather = weather_G.f )
  row.names( df_C.f ) <- df_C.f$code
  row.names( df_G.f ) <- df_G.f$code
  
  # str( df_C.f ) ; str(df_G.f)
  
  save( df_C.f, file="df_C.f.rda" )
  save( df_G.f, file="df_C.f.rda" )
```

```{r}
  # Extracting the weather data for a single farm, say Costa Rica farm 1103
  knitr::kable( summary( df_C.f["1103","weather"][[1]], digits=2 ) )
```
...
```{r, eval=F}
  ...
  y_condsTM_weatherC <- matrix( NA, nSites, n_coords_C.f )
    colnames(y_condsTM_weatherC) <- df_coords_C.f$code
  y_condsTM_weatherG <- matrix( NA, nSites, n_coords_G.f )
    colnames(y_condsTM_weatherG) <- df_coords_G.f$code
...
```{r}
  r2_condsTM_weatherC <- rep( NA, n_coords_C.f )
  r2_condsTM_weatherG <- rep( NA, n_coords_G.f )
...
```{r}
  ...
  plot  ( 1:n_coords_G.f, r2_condsTM_weatherG, col="red", ylim=c(0,1.2*ymax) )
  points( 1:n_coords_C.f, r2_condsTM_weatherC )
  legend( "topleft",
...
```{r}
  iC.r2max     <- which.max( r2_condsTM_weatherC )
  iG.r2max     <- which.max( r2_condsTM_weatherG )
  fC.r2max     <- df_coords_C.f[ iC.r2max, ]
  fG.r2max     <- df_coords_G.f[ iG.r2max, ]
...
```{r, fig.height=8}
  ...
  iC <- which( df_typol.f$code <  2000 )
  iG <- which( df_typol.f$code >= 2000 )
  alt.f.Obs <- df_typol.f$altitude
  y.f.Obs   <- df_typol.f$yield
...
```{r}
  iC.r2max      <- which.max( r2_soil.WC_C )
  iG.r2max      <- which.max( r2_soil.WC_G )
  fcode_C.r2max <- fcode_C.soil.WC[ iC.r2max ]
  fcode_G.r2max <- fcode_G.soil.WC[ iG.r2max ]
