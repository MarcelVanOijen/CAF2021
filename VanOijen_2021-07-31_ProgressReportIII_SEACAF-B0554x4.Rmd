...
Soil measurements were taken in the top 26 cm of the soil. We assume that this layer contains half the soil organic matter.
...
```{r}
  ...
  df_bioph_C <- df_bioph_C0 %>%
    ...
    mutate( C.soil = 2 * DM.soil.00_26 * Cperc.soil.00_26 / 100 ) %>%
    mutate( N.soil = 2 * DM.soil.00_26 * Nperc.soil.00_26 / 100 ) %>%
