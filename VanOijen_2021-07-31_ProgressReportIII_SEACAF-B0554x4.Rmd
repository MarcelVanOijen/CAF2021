...
```{r}
  ...
  coords_C.f  <- cbind( lon=df_C.f$lon, lat=df_C.f$lat )
    row.names( coords_C.f ) <- df_C.f$code
  coords_G.f  <- cbind( lon=df_G.f$lon, lat=df_G.f$lat )
    row.names( coords_G.f ) <- df_G.f$code
...
```{r}
  df_typol <- read_excel( paste0(dir.f,file_typol.f),
                          sheet="data_set" )
  df_typol <- df_typol %>%
...
```{r, fig.height=8}
  iC <- which( df_typol$code <  2000 )
  iG <- which( df_typol$code >= 2000 )
  alt.f.Obs <- df_typol$altitude
  y.f.Obs   <- df_typol$yield
  
  par( mfrow=c(2,2) )
  
  ymax <- max( df_typol$yield )
  plot  ( df_typol$altitude[iC], df_typol$yield[iC], main="yield",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_typol$altitude[iG], df_typol$yield[iG],
          col="red", pch=20 )
  y.lm.C <- lm( df_typol$yield[iC] ~ df_typol$altitude[iC] )
  y.lm.G <- lm( df_typol$yield[iG] ~ df_typol$altitude[iG] )
  r2.C   <- signif( summary(y.lm.C)$r.squared, 2 )
  r2.G   <- signif( summary(y.lm.G)$r.squared, 2 )
  abline( y.lm.C$coefficients[1], y.lm.C$coefficients[2], col="black" )
  abline( y.lm.G$coefficients[1], y.lm.G$coefficients[2], col="red"   )
  legend( "topleft",
          legend=c( paste("r2[C]= ",as.character(r2.C)),
                    paste("r2[G]= ",as.character(r2.G)) ),
          col=c("black","red"), lty=c(1,1), cex=0.7 )
  
  ymax <- max( df_typol$nt )
  plot  ( df_typol$altitude[iC], df_typol$nt[iC], main="# tree spp.",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_typol$altitude[iG], df_typol$nt[iG],
          col="red", pch=20 )
  y.lm.C <- lm( df_typol$nt[iC] ~ df_typol$altitude[iC] )
  y.lm.G <- lm( df_typol$nt[iG] ~ df_typol$altitude[iG] )
  r2.C   <- signif( summary(y.lm.C)$r.squared, 2 )
  r2.G   <- signif( summary(y.lm.G)$r.squared, 2 )
  abline( y.lm.C$coefficients[1], y.lm.C$coefficients[2], col="black" )
  abline( y.lm.G$coefficients[1], y.lm.G$coefficients[2], col="red"   )
  ...
  ymax <- max( df_typol$shade )
  plot  ( df_typol$altitude[iC], df_typol$shade[iC], main="shade",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_typol$altitude[iG], df_typol$shade[iG],
          col="red", pch=20 )
  y.lm.C <- lm( df_typol$shade[iC] ~ df_typol$altitude[iC] )
  y.lm.G <- lm( df_typol$shade[iG] ~ df_typol$altitude[iG] )
  r2.C   <- signif( summary(y.lm.C)$r.squared, 2 )
  r2.G   <- signif( summary(y.lm.G)$r.squared, 2 )
  abline( y.lm.C$coefficients[1], y.lm.C$coefficients[2], col="black" )
  abline( y.lm.G$coefficients[1], y.lm.G$coefficients[2], col="red"   )
  ...
  ymax <- max( df_typol$Nfert )
  plot  ( df_typol$altitude[iC], df_typol$Nfert[iC], main="Nfert",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_typol$altitude[iG], df_typol$Nfert[iG],
          col="red", pch=20 )
  y.lm.C <- lm( df_typol$Nfert[iC] ~ df_typol$altitude[iC] )
  y.lm.G <- lm( df_typol$Nfert[iG] ~ df_typol$altitude[iG] )
  r2.C   <- signif( summary(y.lm.C)$r.squared, 2 )
  r2.G   <- signif( summary(y.lm.G)$r.squared, 2 )
  abline( y.lm.C$coefficients[1], y.lm.C$coefficients[2], col="black" )
  abline( y.lm.G$coefficients[1], y.lm.G$coefficients[2], col="red"   )
...
```{r}
  df_bioph_C0 <- read_excel( paste0(dir.f,file_bioph.f),
                          sheet="Soil_CR_90" )

  df_bioph_C <- df_bioph_C0 %>%
    mutate( code = 1000 + as.numeric(farm_number) ) %>%
    ...
    rename( DM_BL.soil.00_13 = "BL:0-13_airdry_105C"  ) %>%
    rename( DM_BL.soil.13_26 = "BL:13-26_airdry_105C" ) %>%
    rename( DM_BP.soil.00_13 = "BP:0-13_airdry_105C"  ) %>%
    rename( DM_BP.soil.13_26 = "BP:13-26_airdry_105C" ) %>%
    ...
    mutate( DM.soil.00_13 = 0.001 * (10000/78.54) * 0.5 *
              (DM_BL.soil.00_13 + DM_BP.soil.00_13 ) ) %>%
    mutate( DM.soil.13_26 = 0.001 * (10000/78.54) * 0.5 *
              (DM_BL.soil.13_26 + DM_BP.soil.13_26 ) ) %>%
    mutate( DM.soil.00_26 = DM.soil.00_13 + DM.soil.13_26 ) %>%
    mutate( DMfrac.soil = DM.soil.00_26 / (2.6 * 100) ) %>%
    mutate( C.soil = 1.5 * DM.soil.00_26 * Cperc.soil.00_26 / 100 ) %>%
    mutate( N.soil = 1.5 * DM.soil.00_26 * Nperc.soil.00_26 / 100 ) %>%
    dplyr::select( code, DMfrac.soil, CN.soil, C.soil, N.soil ) %>%
    arrange( code )
```

```{r}
  knitr::kable( summary( df_bioph_C ) )
```


```{r}
  df_C.f3 <- df_C.f %>%
    inner_join( df_typol, by="code" ) %>%
    inner_join( df_bioph_C, by="code" )
```

```{r, fig.height=8}
  par( mfrow=c(2,2) )
  
  ymax <- max( df_C.f3$DMfrac.soil )
  plot  ( df_C.f3$altitude, df_C.f3$DMfrac.soil, main="DMfrac.soil",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  y.lm <- lm( df_C.f3$DMfrac.soil ~ df_C.f3$altitude )
  r2   <- signif( summary(y.lm)$r.squared, 2 )
  abline( y.lm$coefficients[1], y.lm$coefficients[2], col="black" )
  legend( "bottomright",
          legend=paste("r2= ",as.character(r2)),
          lty=1, cex=0.7 )
  
  ymax <- max( df_C.f3$CN.soil )
  plot  ( df_C.f3$altitude, df_C.f3$CN.soil, main="CN.soil",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  y.lm <- lm( df_C.f3$CN.soil ~ df_C.f3$altitude )
  r2   <- signif( summary(y.lm)$r.squared, 2 )
  abline( y.lm$coefficients[1], y.lm$coefficients[2], col="black" )
  legend( "bottomright",
          legend=paste("r2= ",as.character(r2)),
  ...
  ymax <- max( df_C.f3$C.soil )
  plot  ( df_C.f3$altitude, df_C.f3$C.soil, main="C.soil",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  y.lm <- lm( df_C.f3$C.soil ~ df_C.f3$altitude )
  r2   <- signif( summary(y.lm)$r.squared, 2 )
  abline( y.lm$coefficients[1], y.lm$coefficients[2], col="black" )
  legend( "bottomright",
          legend=paste("r2= ",as.character(r2)),
  ...
  ymax <- max( df_C.f3$N.soil )
  plot  ( df_C.f3$altitude, df_C.f3$N.soil, main="N.soil",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  y.lm <- lm( df_C.f3$N.soil ~ df_C.f3$altitude )
  r2   <- signif( summary(y.lm)$r.squared, 2 )
  abline( y.lm$coefficients[1], y.lm$coefficients[2], col="black" )
  legend( "bottomright",
          legend=paste("r2= ",as.character(r2)),
...
- Two farms in Guatemala had higher weights in some subsamples after drying at 105 degC: farm 138 (Excel-file rows 1209,1212:1215,1220) and farm 330 (rows 1833:1838). Those subsample weights were set to NA.
...
```{r}
  ...
  df_soil1.f  <- df_soil1.f0 %>%
    ...
    # Capping values where 105C increased weight
                      # NA ) ) %>%
    # Removing values where 105C increased weight
    ...
    mutate( DMfrac.soil = DM.soil.00_26 / (2.6 * 100) ) # DM in kg l-1 in top 26 cm
```

```{r}
  knitr::kable( summary( df_soil1.f ) )
```
...
```{r}
  knitr::kable( summary( df_soil2.f ) )
```
...
```{r}
  df_soil.f <- df_soil1.f %>%
    ...
    inner_join( df_typol, by="code" ) %>%
    select( code, altitude, DMfrac.soil, CN.soil, C.soil, N.soil )
```

```{r}
  knitr::kable( summary( df_soil.f ) )
```

```{r, fig.height=8}
  iC <- which(df_soil.f$code <  2000)
  iG <- which(df_soil.f$code >= 2000)

  par( mfrow=c(2,2), mar=c(4,2,3,2) )
  
  ymax <- max( df_soil.f$DMfrac.soil, na.rm=T )
  plot  ( df_soil.f$altitude[iC], df_soil.f$DMfrac.soil[iC], main="DMfrac.soil (g cm-3)",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_soil.f$altitude[iG], df_soil.f$DMfrac.soil[iG],
          col="red", pch=20 )
  y.lm.C <- lm( df_soil.f$DMfrac.soil[iC] ~ df_soil.f$altitude[iC] )
  y.lm.G <- lm( df_soil.f$DMfrac.soil[iG] ~ df_soil.f$altitude[iG] )
  r2.C   <- signif( summary(y.lm.C)$r.squared, 2 )
  r2.G   <- signif( summary(y.lm.G)$r.squared, 2 )
  abline( y.lm.C$coefficients[1], y.lm.C$coefficients[2], col="black" )
  abline( y.lm.G$coefficients[1], y.lm.G$coefficients[2], col="red"   )
  ...
  ymax <- max( df_soil.f$CN.soil )
  plot  ( df_soil.f$altitude[iC], df_soil.f$CN.soil[iC], main="C/N.soil (-)",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_soil.f$altitude[iG], df_soil.f$CN.soil[iG],
          col="red", pch=20 )
  y.lm.C <- lm( df_soil.f$CN.soil[iC] ~ df_soil.f$altitude[iC] )
  y.lm.G <- lm( df_soil.f$CN.soil[iG] ~ df_soil.f$altitude[iG] )
  r2.C   <- signif( summary(y.lm.C)$r.squared, 2 )
  r2.G   <- signif( summary(y.lm.G)$r.squared, 2 )
  abline( y.lm.C$coefficients[1], y.lm.C$coefficients[2], col="black" )
  abline( y.lm.G$coefficients[1], y.lm.G$coefficients[2], col="red"   )
  ...
  ymax <- max( df_soil.f$C.soil, na.rm=T )
  plot  ( df_soil.f$altitude[iC], df_soil.f$C.soil[iC], main="C.soil (kg C m-2)",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_soil.f$altitude[iG], df_soil.f$C.soil[iG],
          col="red", pch=20 )
  y.lm.C <- lm( df_soil.f$C.soil[iC] ~ df_soil.f$altitude[iC] )
  y.lm.G <- lm( df_soil.f$C.soil[iG] ~ df_soil.f$altitude[iG] )
  r2.C   <- signif( summary(y.lm.C)$r.squared, 2 )
  r2.G   <- signif( summary(y.lm.G)$r.squared, 2 )
  abline( y.lm.C$coefficients[1], y.lm.C$coefficients[2], col="black" )
  abline( y.lm.G$coefficients[1], y.lm.G$coefficients[2], col="red"   )
  ...
  ymax <- max( df_soil.f$N.soil, na.rm=T )
  plot  ( df_soil.f$altitude[iC], df_soil.f$N.soil[iC], main="N.soil (kg N m-2)",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( df_soil.f$altitude[iG], df_soil.f$N.soil[iG],
          col="red", pch=20 )
  y.lm.C <- lm( df_soil.f$N.soil[iC] ~ df_soil.f$altitude[iC] )
  y.lm.G <- lm( df_soil.f$N.soil[iG] ~ df_soil.f$altitude[iG] )
  r2.C   <- signif( summary(y.lm.C)$r.squared, 2 )
  r2.G   <- signif( summary(y.lm.G)$r.squared, 2 )
  abline( y.lm.C$coefficients[1], y.lm.C$coefficients[2], col="black" )
  abline( y.lm.G$coefficients[1], y.lm.G$coefficients[2], col="red"   )
...
```{r, eval=F}
  matrix_C.00_18.f <- matrix( NA, nrow=n_C.f, ncol=228 )
    row.names(matrix_C.00_18.f) <- df_C.f$code
  matrix_G.00_18.f <- matrix( NA, nrow=n_G.f, ncol=228 )
    row.names(matrix_G.00_18.f) <- df_G.f$code
...
```{r, eval=F}
  weather_C.f  <- vector( "list", n_C.f ) ; names( weather_C.f ) <- df_C.f$code
  weather_G.f  <- vector( "list", n_G.f ) ; names( weather_G.f ) <- df_G.f$code
...
```{r}
  ...
  f <- 1
  plot  ( weather_C.f[[f]] [,"GR"  ], main="GR", type="l" )
  plot  ( weather_C.f[[f]] [,"TMAX"], main="TMAX, TMIN (red)", type="l",
          ylim=range(weather_C.f[[f]] [,c("TMAX", "TMIN")]) )
  points( weather_C.f[[f]] [,"TMIN"], col="red", type="l" )
  plot  ( weather_C.f[[f]] [,"VP"  ], main="VP, WN (blue)", type="l",
          ylim=range(weather_C.f[[f]] [,c("VP", "WN")]) )
  points( weather_C.f[[f]] [,"WN"  ], col="blue", type="l" )
  plot  ( weather_C.f[[f]] [,"RAIN"], main="RAIN", type="l" )
```
...
```{r}
  ...
  f <- 1
  plot  ( weather_G.f[[f]] [,"GR"  ], main="GR", type="l" )
  plot  ( weather_G.f[[f]] [,"TMAX"], main="TMAX, TMIN (red)", type="l",
          ylim=range(weather_G.f[[f]] [,c("TMAX", "TMIN")]) )
  points( weather_G.f[[f]] [,"TMIN"], col="red", type="l" )
  plot  ( weather_G.f[[f]] [,"VP"  ], main="VP, WN (blue)", type="l",
          ylim=range(weather_G.f[[f]] [,c("VP", "WN")]) )
  points( weather_G.f[[f]] [,"WN"  ], col="blue", type="l" )
  plot  ( weather_G.f[[f]] [,"RAIN"], main="RAIN", type="l" )
```
...
```{r, out.width="100%"}
  ...
  yC1 <- fYieldsTM( parMatrix=parMAP, sfiles=sitesettings_filenames,
                    WC=TRUE, list_w=weather_C.f, f=1 )
  par( pty="s" ) ; plotYieldsTM( yC1 )
  
  yG1 <- fYieldsTM( parMatrix=parMAP, sfiles=sitesettings_filenames,
                    WC=TRUE, list_w=weather_G.f, f=1 )
  par( pty="s" ) ; plotYieldsTM( yG1 )
  
  yC90 <- fYieldsTM( parMatrix=parMAP, sfiles=sitesettings_filenames,
                    WC=TRUE, list_w=weather_C.f, f=90 )
  par( pty="s" ) ; plotYieldsTM( yC90 )
  
  yG96 <- fYieldsTM( parMatrix=parMAP, sfiles=sitesettings_filenames,
                    WC=TRUE, list_w=weather_G.f, f=96 )
  par( pty="s" ) ; plotYieldsTM( yG96 )
```

```{r, eval=F}
  y_TM.obs           <- rep   ( NA, nSites )
  ...
  source('initialisation/initialise_CAF2021_general.R')
  y_TM.obs <- fYieldsTM( parMatrix=parMAP,
                         sfiles=sitesettings_filenames ) [,"Y.obs"]

  for(f in 1:n_C.f) {
    yCf <- fYieldsTM( parMatrix=parMAP,
                      sfiles=sitesettings_filenames, WC=T, weather_C.f, f )
    y_condsTM_weatherC[,f] <- yCf[,"Y.sim"]
  }

  for(f in 1:n_G.f) {
    yGf <- fYieldsTM( parMatrix=parMAP,
                      sfiles=sitesettings_filenames, WC=T, weather_G.f, f )
    y_condsTM_weatherG[,f] <- yGf[,"Y.sim"]
  }
  
  # save( y_TM.obs, y_condsTM_weatherC, y_condsTM_weatherG,
  #       file="y_TM_CG.rda" )
```
...
```{r}
  r2_condsTM_weatherC <- rep( NA, n_C.f )
  r2_condsTM_weatherG <- rep( NA, n_G.f )

  for(f in 1:n_C.f) {
    yCf.lm <- lm( y_condsTM_weatherC[,f] ~ y_TM.obs )
    r2_condsTM_weatherC[f] <- summary(yCf.lm)$r.squared
  }

  for(f in 1:n_G.f) {
    yGf.lm <- lm( y_condsTM_weatherG[,f] ~ y_TM.obs )
    r2_condsTM_weatherG[f] <- summary(yGf.lm)$r.squared
  }
```

```{r}
  par( mfrow=c(1,1) )
  ymax <- max( r2_condsTM_weatherC, r2_condsTM_weatherG )
  plot  ( 1:n_G.f, r2_condsTM_weatherG, col="red", ylim=c(0,1.2*ymax) )
  points( 1:n_C.f, r2_condsTM_weatherC )
  legend( "topleft",
          legend=c("weather farms C","weather farms G"),
          pch=c(1,1), col=c("black","red"),
          horiz=T )
```
  
```{r}
  iC.r2max <- which.max( r2_condsTM_weatherC ) ; fC.r2max <- df_C.f[ iC.r2max, ]
  iG.r2max <- which.max( r2_condsTM_weatherG ) ; fG.r2max <- df_G.f[ iG.r2max, ]
  
  fC.r2max$alt <- alt_C.f[iC.r2max]
  fG.r2max$alt <- alt_G.f[iG.r2max]
...
```{r, fig.height=8}
  ...
  plot  ( alt_C.f, ymean_C.f_condsTM, main="Costa Rica",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( alt_C.f, ymax_C.f_condsTM, pch=1, cex=0.5 )
  points( alt_C.f, ymin_C.f_condsTM, pch=1, cex=0.5 )
  y.lm <- lm( ymean_C.f_condsTM ~ alt_C.f )
  r2   <- signif( summary(y.lm)$r.squared, 2 )
  ...
  plot  ( alt_G.f, ymean_G.f_condsTM, main="Guatemala",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( alt_G.f, ymax_G.f_condsTM, pch=1, cex=0.5 )
  points( alt_G.f, ymin_G.f_condsTM, pch=1, cex=0.5 )
  y.lm <- lm( ymean_G.f_condsTM ~ alt_G.f )
  r2   <- signif( summary(y.lm)$r.squared, 2 )
  abline( y.lm$coefficients[1], y.lm$coefficients[2], col="blue" )
  legend( "topright",
          legend=paste("r2= ",as.character(r2)),
  ...
  plot  ( alt.f.Obs[iC], y.f.Obs[iC],
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  y.lm <- lm( y.f.Obs[iC] ~ alt.f.Obs[iC] )
  r2   <- signif( summary(y.lm)$r.squared, 2 )
  abline( y.lm$coefficients[1], y.lm$coefficients[2], col="blue" )
  legend( "topright",
          legend=paste("r2= ",as.character(r2)),
  ...
  plot  ( alt.f.Obs[iG], y.f.Obs[iG],
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  y.lm <- lm( y.f.Obs[iG] ~ alt.f.Obs[iG] )
  r2   <- signif( summary(y.lm)$r.squared, 2 )
  abline( y.lm$coefficients[1], y.lm$coefficients[2], col="blue" )
  legend( "topright",
          legend=paste("r2= ",as.character(r2)),
...
```{r}
  ...
  fcode.soil      <- df_soil.f$code
  fcode_C.WC      <- names( weather_C.f )
  fcode_G.WC      <- names( weather_G.f )
  
  fcode_C.soil.WC <- df_soil.f$code[ which( fcode.soil %in% fcode_C.WC ) ]
  fcode_G.soil.WC <- df_soil.f$code[ which( fcode.soil %in% fcode_G.WC ) ]
  n_C.soil.WC     <- length( fcode_C.soil.WC )
  n_G.soil.WC     <- length( fcode_G.soil.WC )
```
...
```{r, out.width="100%"}
  ...
  fcode_C <- fcode_C.soil.WC[2] ; fcode_G <- fcode_G.soil.WC[7]

  fsoil.C    <- which( fcode.soil == fcode_C )
  fsoil.G    <- which( fcode.soil == fcode_G )
  fweather_C <- which( fcode_C.WC == fcode_C ) 
  fweather_G <- which( fcode_G.WC == fcode_G )
  
  ip_CLITT0   <- which( names_params=="CLITT0"  )
  ...
  C_C         <- df_soil.f$C.soil [ fsoil.C ]
  C_G         <- df_soil.f$C.soil [ fsoil.G ]
  CN_C        <- df_soil.f$CN.soil[ fsoil.C ]
  CN_G        <- df_soil.f$CN.soil[ fsoil.G ]
  ...
  yC <- fYieldsTM( parMatrix=parMatrix_C, sfiles=sitesettings_filenames,
                    WC=TRUE, list_w=weather_C.f, f=fweather_C )
  par( pty="s" ) ; plotYieldsTM( yC )
  yG <- fYieldsTM( parMatrix=parMatrix_G, sfiles=sitesettings_filenames,
                    WC=TRUE, list_w=weather_G.f, f=fweather_G )
  par( pty="s" ) ; plotYieldsTM( yG )
```

```{r, eval=F}
  y_soil.WC_C <- matrix( NA, nSites, n_C.soil.WC )
    colnames(y_soil.WC_C) <- fcode_C.soil.WC
  y_soil.WC_G <- matrix( NA, nSites, n_G.soil.WC )
    colnames(y_soil.WC_G) <- fcode_G.soil.WC
  
  parMatrix_C <- parMatrix_G <- parMAP

  for(f in 1:n_C.soil.WC) {
    fcode_C    <- fcode_C.soil.WC[f]
    fsoil.C    <- which( fcode.soil == fcode_C )
    fweather_C <- which( fcode_C.WC == fcode_C ) 
    C_C        <- df_soil.f$C.soil [ fsoil.C ]
    CN_C       <- df_soil.f$CN.soil[ fsoil.C ]
    parMatrix_C[ c(ip_CNLITT0,ip_CNSOMF0,ip_CNSOMS0), ] <- CN_C
    parMatrix_C[ ip_CSOM0                           , ] <- C_C
    yCf <- fYieldsTM( parMatrix=parMatrix_C, sfiles=sitesettings_filenames,
                      WC=TRUE, list_w=weather_C.f, f=fweather_C )
    y_soil.WC_C[,f] <- yCf[,"Y.sim"]
  }

  for(f in 1:n_G.soil.WC) {
    fcode_G    <- fcode_G.soil.WC[f]
    fsoil.G    <- which( fcode.soil == fcode_G )
    fweather_G <- which( fcode_G.WC == fcode_G ) 
    C_G        <- df_soil.f$C.soil [ fsoil.G ]
    CN_G       <- df_soil.f$CN.soil[ fsoil.G ]
    parMatrix_G[ c(ip_CNLITT0,ip_CNSOMF0,ip_CNSOMS0), ] <- CN_G
    parMatrix_G[ ip_CSOM0                           , ] <- C_G
    yGf <- fYieldsTM( parMatrix=parMatrix_G, sfiles=sitesettings_filenames,
                      WC=TRUE, list_w=weather_G.f, f=fweather_G )
    y_soil.WC_G[,f] <- yGf[,"Y.sim"]
  }
...
```{r}
  r2_soil.WC_C <- rep( NA, n_C.soil.WC )
  r2_soil.WC_G <- rep( NA, n_G.soil.WC )

  for(f in 1:n_C.soil.WC) {
    yCf.lm <- lm( y_soil.WC_C[,f] ~ y_TM.obs )
    r2_soil.WC_C[f] <- summary(yCf.lm)$r.squared
  }

  for(f in 1:n_G.soil.WC) {
    yGf.lm <- lm( y_soil.WC_G[,f] ~ y_TM.obs )
    r2_soil.WC_G[f] <- summary(yGf.lm)$r.squared
  }
```

```{r}
  par( mfrow=c(1,1) )
  ymax <- max( r2_soil.WC_C, r2_soil.WC_G )
  plot  ( 1:n_G.soil.WC, r2_soil.WC_G, col="red", ylim=c(0,1.2*ymax) )
  points( 1:n_C.soil.WC, r2_soil.WC_C )
  legend( "topleft",
          legend=c("soil & weather farms C","soil & weather farms G"),
          pch=c(1,1), col=c("black","red"),
          horiz=T )
```
  
```{r}
  iC.r2max <- which.max( r2_soil.WC_C ) ; fcode_C.r2max <- fcode_C.soil.WC[ iC.r2max ]
  iG.r2max <- which.max( r2_soil.WC_G ) ; fcode_G.r2max <- fcode_G.soil.WC[ iG.r2max ]
...
```{r}
  alt_C.soil.WC <- rep( NA, n_C.soil.WC )
  alt_G.soil.WC <- rep( NA, n_G.soil.WC )

  for(f in 1:n_C.soil.WC) {
    fcode_C          <- fcode_C.soil.WC[f]
    fsoil.C          <- which( fcode.soil == fcode_C )
    alt_C.soil.WC[f] <- df_soil.f$altitude[ fsoil.C ]
  }

  for(f in 1:n_G.soil.WC) {
    fcode_G          <- fcode_G.soil.WC[f]
    fsoil.G          <- which( fcode.soil == fcode_G )
    alt_G.soil.WC[f] <- df_soil.f$altitude[ fsoil.G ]
  }
```
...
```{r, fig.height=8}
  ...
  plot  ( alt_C.soil.WC, ymean_C.f_soil.WC, main="Costa Rica",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( alt_C.soil.WC, ymax_C.f_soil.WC, pch=1, cex=0.5 )
  points( alt_C.soil.WC, ymin_C.f_soil.WC, pch=1, cex=0.5 )
  y.lm <- lm( ymean_C.f_soil.WC ~ alt_C.soil.WC )
  r2   <- signif( summary(y.lm)$r.squared, 2 )
  abline( y.lm$coefficients[1], y.lm$coefficients[2], col="blue" )
  legend( "topright",
          legend=paste("r2= ",as.character(r2)),
  ...
  plot  ( alt_G.soil.WC, ymean_G.f_soil.WC, main="Guatemala",
          xlab="Alt. (m)", ylab="", ylim=c(0,ymax), pch=20 )
  points( alt_G.soil.WC, ymax_G.f_soil.WC, pch=1, cex=0.5 )
  points( alt_G.soil.WC, ymin_G.f_soil.WC, pch=1, cex=0.5 )
  y.lm <- lm( ymean_G.f_soil.WC ~ alt_G.soil.WC )
  r2   <- signif( summary(y.lm)$r.squared, 2 )
  abline( y.lm$coefficients[1], y.lm$coefficients[2], col="blue" )
  legend( "topright",
          legend=paste("r2= ",as.character(r2)),
