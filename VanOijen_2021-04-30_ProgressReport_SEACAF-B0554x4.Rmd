...
An empirical temperature- and rainfall-dependent banana model based on EcoCrop was proposed by [@VanDenBergh_2012_Climate]. Their model used the following critical monthly temperatures: $T_{kill}$ = 0 $^{\circ}$C, $T_{min}$ = 12 $^{\circ}$C, $T_{opt}$ = 17.5 to 26.3 $^{\circ}$C, $T_{max}$ = 33 $^{\circ}$C.
