...
```{r list_outF_C}
  ...
  for(fi in 1:n_C.f) {
    ...
    for(iF in 1:nF_C) {
      ...
      if( iF==2 ) {
        params_fi[ ip_FCSOMF0 ] <- 0.5
        params_fi[ ip_CSOM0   ] <- 20
        params_fi[ ip_FWCWP   ] <- 0.1
      }
...
```{r}
  ...
  plot( df_C.f$C.soil, F1_C[,"Csoil_f"] ) ; abline(a=0,b=1,lty=2)
  plot( df_C.f$shade , F1_C[,"Shade_f"] ) ; abline(a=0,b=1,lty=2)
  
  plot( df_C.f$C.soil, F2_C[,"Csoil_f"] ) ; abline(a=0,b=1,lty=2)
  plot( df_C.f$shade , F2_C[,"Shade_f"] ) ; abline(a=0,b=1,lty=2)
```
...
```{r}
  ...
  plot( df_G.f$C.soil, F1_G[,"Csoil_f"] ) ; abline(a=0,b=1,lty=2)
  plot( df_G.f$shade , F1_G[,"Shade_f"] ) ; abline(a=0,b=1,lty=2)

  plot( df_G.f$C.soil, F2_G[,"Csoil_f"] ) ; abline(a=0,b=1,lty=2)
  plot( df_G.f$shade , F2_G[,"Shade_f"] ) ; abline(a=0,b=1,lty=2)
```
...
- Lower Nsoil
- Lower Nfert
- Lower soil water holding capacity
