...
```{r}
  ...
  pAll     <- c("KEXT","RUBISC","TRANCO","YG","TCSOMF","TCSOMS","WCSTMULT")
  npAll    <- length(pAll) ; ipAll <- rep(NA,npAll)
  for(p in 1:npAll) { ipAll[p]     <- which( names_params==pAll[p] ) }

  pT       <- c("FLTMAX","FST","FWT","KAC","KACEXP","KH","KHEXP",
                "LAIMAXT","LUEMAX","SLAT")
  ...
  df_par_BC_C <- df_par_BC_C %>%
    ...
    mutate( val.min = round( val * 0.8 , 4 ) ) %>%
    mutate( val.max = round( val * 1.25, 4 ) ) %>%
    ...
    mutate ( farms = ifelse( (species==1 & endsWith(name,"1)") ), "if_C.1E",
                     ...
                     ifelse( (species==2 & endsWith(name,"3)") ), "if_C.3C",
                              "1:nSites" )))))) )
    # mutate ( farms = ifelse( (species==1 & endsWith(name,"1)") ), vecstr(if_C.1E),
    #                  ifelse( (species==2 & endsWith(name,"1)") ), vecstr(if_C.1I),
    #                  ifelse( (species==1 & endsWith(name,"2)") ), vecstr(if_C.2B),
    #                  ifelse( (species==2 & endsWith(name,"2)") ), vecstr(if_C.2A),
    #                  ifelse( (species==1 & endsWith(name,"3)") ), vecstr(if_C.3G),
    #                  ifelse( (species==2 & endsWith(name,"3)") ), vecstr(if_C.3C),
    #                           "1:nSites" )))))) )
```
  ...
  df_par_BC_G <- df_par_BC_G %>%
    ...
    mutate ( farms = ifelse( (             endsWith(name,"1)") ), "if_G.1I",
                     ...
                     ifelse( (species==2 & endsWith(name,"3)") ), "if_G.3C",
                              "1:nSites" ))))) )
    # mutate ( farms = ifelse( (             endsWith(name,"1)") ), vecstr(if_G.1I),
    #                  ifelse( (species==1 & endsWith(name,"2)") ), vecstr(if_G.2B),
    #                  ifelse( (species==2 & endsWith(name,"2)") ), vecstr(if_G.2A),
    #                  ifelse( (species==1 & endsWith(name,"3)") ), vecstr(if_G.3G),
    #                  ifelse( (species==2 & endsWith(name,"3)") ), vecstr(if_G.3C),
    #                           "1:nSites" ))))) )
```
...
```{r, echo=T}
  summary( oF2_C[if_C.1E,"CAtree_t_1b"], digits=3 ) # Erythrina final two years
  summary( oF2_C[if_C.1I,"CAtree_t_1b"], digits=3 ) # Inga final two years
  summary( oF2_C[if_C.2B,"CAtree_t_2b"], digits=3 ) # Banana final two years
  summary( oF2_C[if_C.2A,"CAtree_t_2b"], digits=3 ) # Avocado final two years
  summary( oF2_C[if_C.3G,"CAtree_t_3b"], digits=3 ) # Grevillea final two years
  summary( oF2_C[if_C.3C,"CAtree_t_3b"], digits=3 ) # Cordia final two years

  summary( oF2_C[if_C.1E,"H_t_1b"], digits=3 ) # Erythrina final two years
  summary( oF2_C[if_C.1I,"H_t_1b"], digits=3 ) # Inga final two years
  summary( oF2_C[if_C.2B,"H_t_2b"], digits=3 ) # Banana final two years
  summary( oF2_C[if_C.2A,"H_t_2b"], digits=3 ) # Avocado final two years
  summary( oF2_C[if_C.3G,"H_t_3b"], digits=3 ) # Grevillea final two years
  summary( oF2_C[if_C.3C,"H_t_3b"], digits=3 ) # Cordia final two years
```
...
```{r, echo=T}
  summary( oF2_G[if_G.1I,"CAtree_t_1b"], digits=3 ) # Inga final two years
  summary( oF2_G[if_G.2B,"CAtree_t_2b"], digits=3 ) # Banana final two years
  summary( oF2_G[if_G.2A,"CAtree_t_2b"], digits=3 ) # Avocado final two years
  summary( oF2_G[if_G.3G,"CAtree_t_3b"], digits=3 ) # Grevillea final two years
  summary( oF2_G[if_G.3C,"CAtree_t_3b"], digits=3 ) # Cordia final two years

  summary( oF2_G[if_G.1I,"H_t_1b"], digits=3 ) # Inga final two years
  summary( oF2_G[if_G.2B,"H_t_2b"], digits=3 ) # Banana final two years
  summary( oF2_G[if_G.2A,"H_t_2b"], digits=3 ) # Avocado final two years
  summary( oF2_G[if_G.3G,"H_t_3b"], digits=3 ) # Grevillea final two years
  summary( oF2_G[if_G.3C,"H_t_3b"], digits=3 ) # Cordia final two years
```
