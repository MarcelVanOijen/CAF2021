...
## New code for running all farms, creating farm-specific initialisation files
...
```{r}
  sapply( paste0(dir.init,"inititialise_CAF2021_C_f",1:n_C.f,".R"), file.create)
```

```{r}
  i <- 1

  file.f <- paste0( dir.init, "inititialise_CAF2021_C_f", i, ".R" )
  conn.f <- file( file.f )
    
  writeLines( c( "  set_params(QQQ)",
                 "  set_weather(QQQ)"), conn.f )
  writeLines( c( "  next command line 1)",
                 "  line 2"), conn.f )
  writeLines( c( "  following command line 3)",
                 "  line 4"), conn.f )
...
## Original code for running all farms
...
```{r list_outF_C}
  ...
  for(fi in 1:n_C.f) {
    ...
    for(iF in 1:nF_C) {
      ...
      mat_parF[iF,1+(1:length(names_params))] <- params_fi
...
```{r}
  plotimpacts_CG.Nfert <- function( FC=oF1_C, FG=oF1_G, yvar="y.sim" ){
...
```{r XX31, fig.height=7.5, fig.cap="\\label{fig:XX31}XX31."}
  ...
  yp <- "KH(1)"     ; plotimpacts_CG.Nfert( FC=pF1_C, FG=pF1_G, yvar=yp )
  yp <- "KHEXP(1)"  ; plotimpacts_CG.Nfert( FC=pF1_C, FG=pF1_G, yvar=yp )
  yp <- "KAC(1)"    ; plotimpacts_CG.Nfert( FC=pF1_C, FG=pF1_G, yvar=yp )
  yp <- "KACEXP(1)" ; plotimpacts_CG.Nfert( FC=pF1_C, FG=pF1_G, yvar=yp )
  
  yp <- "KH(2)"     ; plotimpacts_CG.Nfert( FC=pF1_C, FG=pF1_G, yvar=yp )
  yp <- "KHEXP(2)"  ; plotimpacts_CG.Nfert( FC=pF1_C, FG=pF1_G, yvar=yp )
  yp <- "KAC(2)"    ; plotimpacts_CG.Nfert( FC=pF1_C, FG=pF1_G, yvar=yp )
  yp <- "KACEXP(2)" ; plotimpacts_CG.Nfert( FC=pF1_C, FG=pF1_G, yvar=yp )

  yp <- "KH(3)"     ; plotimpacts_CG.Nfert( FC=pF1_C, FG=pF1_G, yvar=yp )
  yp <- "KHEXP(3)"  ; plotimpacts_CG.Nfert( FC=pF1_C, FG=pF1_G, yvar=yp )
  yp <- "KAC(3)"    ; plotimpacts_CG.Nfert( FC=pF1_C, FG=pF1_G, yvar=yp )
  yp <- "KACEXP(3)" ; plotimpacts_CG.Nfert( FC=pF1_C, FG=pF1_G, yvar=yp )
```
...
```{r XX21, fig.height=7.5, fig.cap="\\label{fig:XX21}XX21."}
  ...
  yv <- "fTranT_t_1a"   ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
  yv <- "fTranT_t_1b"   ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )

  yv <- "fNgrowth_t_1a" ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
  yv <- "fNgrowth_t_1b" ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
```
...
```{r XX22, fig.height=7.5, fig.cap="\\label{fig:XX22}XX22."}
  ...
  yv <- "fTranT_t_2a"   ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
  yv <- "fTranT_t_2b"   ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )

  yv <- "fNgrowth_t_2a" ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
  yv <- "fNgrowth_t_2b" ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
```
...
```{r XX23, fig.height=7.5, fig.cap="\\label{fig:XX23}XX23."}
  ...
  yv <- "fTranT_t_3a"   ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
  yv <- "fTranT_t_3b"   ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )

  yv <- "fNgrowth_t_3a" ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
  yv <- "fNgrowth_t_3b" ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                          plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
```
...
```{r XX24, fig.height=7.5, fig.cap="\\label{fig:XX24}XX24."}
  ...
  yv <- "H_t_1a"      ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
  yv <- "H_t_1b"      ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )

  yv <- "CAtree_t_1a" ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
  yv <- "CAtree_t_1b" ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
```
...
```{r XX25, fig.height=7.5, fig.cap="\\label{fig:XX25}XX25."}
  ...
  yv <- "H_t_2a"      ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
  yv <- "H_t_2b"      ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )

  yv <- "CAtree_t_2a" ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
  yv <- "CAtree_t_2b" ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
```
...
```{r XX26, fig.height=7.5, fig.cap="\\label{fig:XX26}XX26."}
  ...
  yv <- "H_t_3a"      ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
  yv <- "H_t_3b"      ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )

  yv <- "CAtree_t_3a" ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
  yv <- "CAtree_t_3b" ; plotimpacts_CG.Nfert( FC=oF1_C, FG=oF1_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF2_C, FG=oF2_G, yvar=yv )
                        plotimpacts_CG.Nfert( FC=oF3_C, FG=oF3_G, yvar=yv )
```
...
```{r, echo=T}
  ...
  cat( mean(oF1_C[,"harvDM_f_ha1819"]), mean(oF2_C[,"harvDM_f_ha1819"]),
       mean(oF3_C[,"harvDM_f_ha1819"]) )
       
  mean(df_C.f$yield1920,na.rm=T)
  cat( mean(oF1_C[,"harvDM_f_ha1920"]), mean(oF2_C[,"harvDM_f_ha1920"]),
       mean(oF3_C[,"harvDM_f_ha1920"]) )
                                   
  print(mean(df_G.f$yield1819))
  cat( mean(oF1_G[,"harvDM_f_ha1819"]), mean(oF2_G[,"harvDM_f_ha1819"]),
       mean(oF3_G[,"harvDM_f_ha1819"]) )

  print( mean(df_G.f$yield1920,na.rm=T))
  cat( mean(oF1_G[,"harvDM_f_ha1920"]), mean(oF2_G[,"harvDM_f_ha1920"]),
       mean(oF3_G[,"harvDM_f_ha1920"]) )
```
...
```{r XX13, fig.height=4, fig.cap="\\label{fig:XX13}Simulated yields in 2018-19 and 2019-20 vs. long-term average yields in the same simulations."}
  ...
  plot  ( oF1_C[,"harvDM_f_hay"], oF1_C[,"harvDM_f_ha1819"],
          main="Costa Rica (sim.)",
          xlab="mean yield", ylab="kg DM ha-1 y-1")
  points( oF1_C[,"harvDM_f_hay"], oF1_C[,"harvDM_f_ha1920"], col="red" )
  abline( 1, 1, lty=2 )
  legend( "bottomright",legend=c("y=x","18/19","19/20"),
          lty=c(2,NA,NA), pch=c(NA,1,1), col=c("black","black","red"),
          bg="transparent" )
  
  plot  ( oF1_G[,"harvDM_f_hay"], oF1_G[,"harvDM_f_ha1819"],
          main="Guatemala (sim.)",
          xlab="mean yield", ylab="yield 2018/19")
  points( oF1_G[,"harvDM_f_hay"], oF1_G[,"harvDM_f_ha1920"], col="red" )
  abline( 1, 1, lty=2 )
  legend( "bottomright",legend=c("y=x","18/19","19/20"),
          lty=c(2,NA,NA), pch=c(NA,1,1), col=c("black","black","red"),
          bg="transparent" )
