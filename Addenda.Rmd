...
```{r}
  ...
  # matMAP_C <- readRDS( "CAF2021_parMAP_03_28.rds" )
  # matMAP_G <- readRDS( "CAF2021_parMAP_12_57.rds" )

  # source('BC_CAF2021_C.R') ; matMAP_C <- matMAP
  # source('BC_CAF2021_G.R') ; matMAP_G <- matMAP

  matMAP_C <- readRDS( "CAF2021_parMAP_01_24.rds" )
  matMAP_G <- readRDS( "CAF2021_parMAP_10_49.rds" )
```
