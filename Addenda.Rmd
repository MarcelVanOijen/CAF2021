...
```{r list_outF_C}
  ...
  for(fi in 1:n_C.f) {
    ...
    for(iF in 1:nF_C) {
      ...
      if( iF==3 ) {
        params <- matMAP_C[,fi]
        params <- set_par( c("KEXT","RUBISC","TRANCO","YG" ),
                           c( 0.48 , 0.92   , 6.3    , 0.7) )
        # params <- set_par( c("KEXT","RUBISC","TRANCO","YG" ),
        #                    c( 0.53 , 1      , 5.7    , 0.56) )
        if( fi %in% if_C.1E ) { params <- set_par(
            c("KAC(2)","KACEXP(2)","KH(2)","KHEXP(2)"),c(9.1,0.6,3.7,0.25)) }
        if( fi %in% if_G.1I ) { params <- set_par(
            c("KAC(2)","KACEXP(2)","KH(2)","KHEXP(2)"),c(6,0.5,6.5,0.25)) }
        if( fi %in% if_G.2B ) { params <- set_par(
            c("KAC(2)","KACEXP(2)","KH(2)","KHEXP(2)"),c(5,0.6,4,0.4))
          params <- set_par(
            c("CBtree0(2)","CLtree0(2)","CRtree0(2)","CStree0(2)"),c(1,1,1,1)) }
        if( fi %in% if_G.2A ) { params <- set_par(
            c("KAC(2)","KACEXP(2)","KH(2)","KHEXP(2)"),c(4,0.6,3,0.4)) }
        if( fi %in% if_G.3G ) { params <- set_par(
            c("KAC(2)","KACEXP(2)","KH(2)","KHEXP(2)"),c(6.7,0.63,5,0.25)) }
        if( fi %in% if_G.3C ) { params <- set_par(
            c("KAC(2)","KACEXP(2)","KH(2)","KHEXP(2)"),c(6.7,0.7,5.6,0.33)) }
        # if( fi %in% if_C.1E ) { params <- set_par(
        #     c("KAC(2)","KACEXP(2)","KH(2)","KHEXP(2)"),c(8.0,0.45,3.6,0.21)) }
        # if( fi %in% if_C.1I ) { params <- set_par(
        #     c("KAC(2)","KACEXP(2)","KH(2)","KHEXP(2)"),c(6.2,0.58,4.9,0.24)) }
        # if( fi %in% if_C.2B ) { params <- set_par(
        #     c("KAC(2)","KACEXP(2)","KH(2)","KHEXP(2)"),c(4.9,0.62,3.9,0.44))
        #   params <- set_par(
        #     c("CBtree0(2)","CLtree0(2)","CRtree0(2)","CStree0(2)"),c(1,1,1,1)) }
        # if( fi %in% if_C.2A ) { params <- set_par(
        #     c("KAC(2)","KACEXP(2)","KH(2)","KHEXP(2)"),c(4.4,0.60,3.0,0.36)) }
        # if( fi %in% if_C.3G ) { params <- set_par(
        #     c("KAC(2)","KACEXP(2)","KH(2)","KHEXP(2)"),c(6.2,0.53,5.0,0.27)) }
        # if( fi %in% if_C.3C ) { params <- set_par(
        #     c("KAC(2)","KACEXP(2)","KH(2)","KHEXP(2)"),c(6.6,0.66,6.1,0.34)) }
