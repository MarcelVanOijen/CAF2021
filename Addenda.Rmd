...
```{r}
  outputSummary <- function( output ) {
    ...
    fOut[,"fTranT_t_1a"] <- mean( outputFirstYears[ifTranT1] )
    fOut[,"fTranT_t_1b"] <- mean( outputFinalYears[ifTranT1] )
    fOut[,"fTranT_t_2a"] <- mean( outputFirstYears[ifTranT2] )
    fOut[,"fTranT_t_2b"] <- mean( outputFinalYears[ifTranT2] )
    fOut[,"fTranT_t_3a"] <- mean( outputFirstYears[ifTranT3] )
...
```{r}
  ...
  yvar <- "fTranT_t_1a"
  x=df_C.f$Nfert ; y=F1_C[,yvar] ; plotxylm(paste0("F1a: ",yvar), orig=F)
  x=df_C.f$Nfert ; y=F2_C[,yvar] ; plotxylm(paste0("F2a: ",yvar), orig=F)
  x=df_C.f$Nfert ; y=F3_C[,yvar] ; plotxylm(paste0("F3a: ",yvar), orig=F)

  yvar <- "fTranT_t_1b"
  x=df_C.f$Nfert ; y=F1_C[,yvar] ; plotxylm(paste0("F1b: ",yvar), orig=F)
  x=df_C.f$Nfert ; y=F2_C[,yvar] ; plotxylm(paste0("F2b: ",yvar), orig=F)
  x=df_C.f$Nfert ; y=F3_C[,yvar] ; plotxylm(paste0("F3b: ",yvar), orig=F)
```
...
```{r}
  ...
  yvar <- "fTranT_t_1a"
  x=df_G.f$Nfert ; y=F1_G[,yvar] ; plotxylm(paste0("F1a: ",yvar), orig=F)
  x=df_G.f$Nfert ; y=F2_G[,yvar] ; plotxylm(paste0("F2a: ",yvar), orig=F)
  x=df_G.f$Nfert ; y=F3_G[,yvar] ; plotxylm(paste0("F3a: ",yvar), orig=F)

  yvar <- "fTranT_t_1b"
  x=df_G.f$Nfert ; y=F1_G[,yvar] ; plotxylm(paste0("F1b: ",yvar), orig=F)
  x=df_G.f$Nfert ; y=F2_G[,yvar] ; plotxylm(paste0("F2b: ",yvar), orig=F)
  x=df_G.f$Nfert ; y=F3_G[,yvar] ; plotxylm(paste0("F3b: ",yvar), orig=F)
```
