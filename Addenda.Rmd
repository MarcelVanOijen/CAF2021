...
```{r}
  df_yield1920_C.f <- df_yield1920.f %>% subset( df_yield1920.f$code <  2000 )
  df_yield1920_G.f <- df_yield1920.f %>% subset( df_yield1920.f$code >= 2000 )
```
...
```{r}
  df_trees_C.f <- df_trees.f %>% subset( df_trees.f$code <  2000 )
  df_trees_G.f <- df_trees.f %>% subset( df_trees.f$code >= 2000 )
```
...
```{r list_outF_C}
  ...
  for(fi in 1:n_C.f) {
    ...
    years.prun1     <- calendar_prunT[1,,1]
    years.prun3     <- calendar_prunT[3,,1]
    doys.prun1      <- calendar_prunT[1,,2]
    doys.prun3      <- calendar_prunT[3,,2]
    fractions.prun1 <- calendar_prunT[1,,3]
    fractions.prun3 <- calendar_prunT[3,,3]
    calendar_prunT  <- set_calendar_prunT( 1,
      years=years.prun1, doys=doys.prun1, fractions=fractions.prun1 )
    calendar_prunT  <- set_calendar_prunT( 2 )
    calendar_prunT  <- set_calendar_prunT( 3,
      years=years.prun3, doys=doys.prun3, fractions=fractions.prun3 )
    
    years.thin1     <- calendar_thinT[1,,1]
    years.thin3     <- calendar_thinT[3,,1]
    doys.thin1      <- calendar_thinT[1,,2]
    doys.thin3      <- calendar_thinT[3,,2]
    fractions.thin1 <- calendar_thinT[1,,3]
    fractions.thin3 <- calendar_thinT[3,,3]
    calendar_thinT  <- set_calendar_thinT( 1,
      years=years.thin1, doys=doys.thin1, fractions=fractions.thin1 )
    calendar_thinT  <- set_calendar_thinT( 2 )
    calendar_thinT  <- set_calendar_thinT( 3,
      years=years.thin3, doys=doys.thin3, fractions=fractions.thin3 )
    
    calendar_prunT <- set_prunT("C", densE_C, densI_C, densB_C, densA_C, 
                                     densG_C, densC_C, calendar_prunT )
    calendar_thinT <- set_thinT("C", densE_C, densI_C, densB_C, densA_C,
                                     densG_C, densC_C, calendar_thinT )

    params <- parMAP[,31]
    params <- set_parT( "C", densE_C, densI_C, densB_C,
                             densA_C, densG_C, densC_C )
    
    # for(i in 1:2) {
    for(i in 2:2) {
      if(i==2) {
        if(df_C.f$nt[fi]==0) { params <- set_par("TREEDENS0(1)",0)
                               params <- set_par("TREEDENS0(3)",0) }
        if(df_C.f$nt[fi]==1) { params <- set_par("TREEDENS0(3)",0) }
        if(df_C.f$nt[fi] >2) { params <- set_par_speciesT(2,"Banana") }
      }
      ...
      params[ ip_FHARVBT1 ] <- 1
      params[ ip_FHARVBT2 ] <- 1
      params[ ip_FHARVBT3 ] <- 1
      params[ ip_FHARVLT1 ] <- 0
      params[ ip_FHARVLT2 ] <- 0
      params[ ip_FHARVLT3 ] <- 0
      params[ ip_PRUNTARGET1 ] <- 1
      params[ ip_PRUNTARGET2 ] <- 1
      params[ ip_PRUNTARGET3 ] <- 1
      params[ ip_THINTARGET1 ] <- 0
      params[ ip_THINTARGET2 ] <- 0
      params[ ip_THINTARGET3 ] <- 0
      outF <- run_model( params, matrix_weather_fi, calendar_fert_fi,
        calendar_prunC, calendar_prunT, calendar_thinT, NDAYS_fi )
...
```{r list_outF_G}
  ...
  for(fi in 1:n_G.f) {
    ...
    for(i in 2:2) {
      if(i==2) {
        if(df_G.f$nt[fi]==0) { params <- set_par("TREEDENS0(1)",0)
                               params <- set_par("TREEDENS0(3)",0) }
        if(df_G.f$nt[fi]==1) { params <- set_par("TREEDENS0(3)",0) }
        if(df_G.f$nt[fi] >2) { params <- set_par_speciesT(2,"Banana") }
      }
...
```{r}
  ...
  F1_C <- dfoutFSummary( df, Fi=1 ) ; F2_C <- dfoutFSummary( df, Fi=2 )
  ...
  df <- df_G.f_sim
  F1_G <- dfoutFSummary( df, Fi=1 ) ; F2_G <- dfoutFSummary( df, Fi=2 )
...
Fig. \ref{fig:XX13} shows that, in the simulations, yields in 2018-19 were slightly below the long-term average for many farms in Costa Rica, but above-average in Guatemala.

```{r XX13, fig.height=4, fig.cap="\\label{fig:XX13}Simulated yields in 2018-19 vs. long-term average yields in the same simulations."}
  par( mfrow=c(1,2), mar=c(3,3,2,2) )

  plot( yF2_C.f_sim, yF2_C.f_sim1819, main="Costa Rica (sim.)",
        xlab="mean yield", ylab="kg DM ha-1 y-1")
  points( yF2_C.f_sim, yF2_C.f_sim1920, col="red" )
  abline(1,1,lty=2)
  legend( "bottomright",legend=c("y=x","18/19","19/20"),
          lty=c(2,NA,NA), pch=c(NA,1,1), col=c("black","black","red"),
          bg="transparent" )
  
  plot( yF2_G.f_sim, yF2_G.f_sim1819, main="Guatemala (sim.)",
        xlab="mean yield", ylab="yield 2018/19")
  points( yF2_G.f_sim, yF2_G.f_sim1920, col="red" )
  abline(1,1,lty=2)
  legend( "bottomright",legend=c("y=x","18/19","19/20"),
          lty=c(2,NA,NA), pch=c(NA,1,1), col=c("black","black","red"),
          bg="transparent" )
...
```{r}
  listmat_nt_C[[1]] <- t( sapply( 1:nnt1_C, function(i){ cbind(
    ...
    df_C.f_sim[int1_C,]$outF     [[i]][,"harvDM_f_ha1819"][2],
    df_C.f_sim[int1_C,]$outF     [[i]][,"harvDM_f_ha1920"][2],
    df_C.f_sim[int1_C,]$outF     [[i]][,"harvDM_f_hay"   ][2],
    df_C.f_sim[int1_C,]$outF     [[i]][,"D_Csoil"        ][2],
    df_C.f_sim[int1_C,]$outF     [[i]][,"Shade_f"        ][2],
    df_C.f_sim[int1_C,]$outF     [[i]][,"Nleaching_f"    ][2],
    df_C.f_sim[int1_C,]$outF     [[i]][,"Crunoff_f"      ][2],
    df_C.f_sim[int1_C,]$outF     [[i]][,"Csoil_f"        ][2]
  ) } ) )
  ...
  listmat_nt_C[[2]] <- t( sapply( 1:nnt2_C, function(i){ cbind(
    ...
    df_C.f_sim[int2_C,]$outF     [[i]][,"harvDM_f_ha1819"][2],
    df_C.f_sim[int2_C,]$outF     [[i]][,"harvDM_f_ha1920"][2],
    df_C.f_sim[int2_C,]$outF     [[i]][,"harvDM_f_hay"   ][2],
    df_C.f_sim[int2_C,]$outF     [[i]][,"D_Csoil"        ][2],
    df_C.f_sim[int2_C,]$outF     [[i]][,"Shade_f"        ][2],
    df_C.f_sim[int2_C,]$outF     [[i]][,"Nleaching_f"    ][2],
    df_C.f_sim[int2_C,]$outF     [[i]][,"Crunoff_f"      ][2],
    df_C.f_sim[int2_C,]$outF     [[i]][,"Csoil_f"        ][2]
  ) } ) )
  ...
  listmat_nt_C[[3]] <- t( sapply( 1:nnt3_C, function(i){ cbind(
    ...
    df_C.f_sim[int3_C,]$outF     [[i]][,"harvDM_f_ha1819"][2],
    df_C.f_sim[int3_C,]$outF     [[i]][,"harvDM_f_ha1920"][2],
    df_C.f_sim[int3_C,]$outF     [[i]][,"harvDM_f_hay"   ][2],
    df_C.f_sim[int3_C,]$outF     [[i]][,"D_Csoil"        ][2],
    df_C.f_sim[int3_C,]$outF     [[i]][,"Shade_f"        ][2],
    df_C.f_sim[int3_C,]$outF     [[i]][,"Nleaching_f"    ][2],
    df_C.f_sim[int3_C,]$outF     [[i]][,"Crunoff_f"      ][2],
    df_C.f_sim[int3_C,]$outF     [[i]][,"Csoil_f"        ][2]
  ) } ) )
...
```{r}
  listmat_nt_G[[1]] <- t( sapply( 1:nnt1_G, function(i){ cbind(
    ...
    df_G.f_sim[int1_G,]$outF     [[i]][,"harvDM_f_ha1819"][2],
    df_G.f_sim[int1_G,]$outF     [[i]][,"harvDM_f_ha1920"][2],
    df_G.f_sim[int1_G,]$outF     [[i]][,"harvDM_f_hay"   ][2],
    df_G.f_sim[int1_G,]$outF     [[i]][,"D_Csoil"        ][2],
    df_G.f_sim[int1_G,]$outF     [[i]][,"Shade_f"        ][2],
    df_G.f_sim[int1_G,]$outF     [[i]][,"Nleaching_f"    ][2],
    df_G.f_sim[int1_G,]$outF     [[i]][,"Crunoff_f"      ][2],
    df_G.f_sim[int1_G,]$outF     [[i]][,"Csoil_f"        ][2]
  ) } ) )
  ...
  listmat_nt_G[[2]] <- t( sapply( 1:nnt2_G, function(i){ cbind(
    ...
    df_G.f_sim[int2_G,]$outF     [[i]][,"harvDM_f_ha1819"][2],
    df_G.f_sim[int2_G,]$outF     [[i]][,"harvDM_f_ha1920"][2],
    df_G.f_sim[int2_G,]$outF     [[i]][,"harvDM_f_hay"   ][2],
    df_G.f_sim[int2_G,]$outF     [[i]][,"D_Csoil"        ][2],
    df_G.f_sim[int2_G,]$outF     [[i]][,"Shade_f"        ][2],
    df_G.f_sim[int2_G,]$outF     [[i]][,"Nleaching_f"    ][2],
    df_G.f_sim[int2_G,]$outF     [[i]][,"Crunoff_f"      ][2],
    df_G.f_sim[int2_G,]$outF     [[i]][,"Csoil_f"        ][2]
  ) } ) )
  ...
  listmat_nt_G[[3]] <- t( sapply( 1:nnt3_G, function(i){ cbind(
    ...
    df_G.f_sim[int3_G,]$outF     [[i]][,"harvDM_f_ha1819"][2],
    df_G.f_sim[int3_G,]$outF     [[i]][,"harvDM_f_ha1920"][2],
    df_G.f_sim[int3_G,]$outF     [[i]][,"harvDM_f_hay"   ][2],
    df_G.f_sim[int3_G,]$outF     [[i]][,"D_Csoil"        ][2],
    df_G.f_sim[int3_G,]$outF     [[i]][,"Shade_f"        ][2],
    df_G.f_sim[int3_G,]$outF     [[i]][,"Nleaching_f"    ][2],
    df_G.f_sim[int3_G,]$outF     [[i]][,"Crunoff_f"      ][2],
    df_G.f_sim[int3_G,]$outF     [[i]][,"Csoil_f"        ][2]
  ) } ) )
