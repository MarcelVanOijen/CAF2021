...
- Central American conditions: mountainous topography with young volcanic soils leading to strong spatial variation in weather patterns and fertility. Together with wide variation in management choices, this leads to strong variability in CAF systems behaviour.
...
- Details of model structure are provided below (Materials and Methods) and online.
...
- Lower Nfert in C leading to lower N-leaching. However, it also led to lower plant gorwth and thus lower carbon-addition to the system.
