...
- ES-estimation only preliminary due to the limited database for model calibration and testing: there is a beed for multivariate calibration data, not just yield, and from locations differing in growing conditions.
