...
```{r}
  load("BC_Turrialba_Masatepe_06_45.RData")
...
```{r XX31F1234, fig.height=7.5, fig.cap="\\label{fig:XX32}Four different simulations (blue) for 4 farm types in Costa Rica. Farm type codes ranging from 1 = very low to 4 = high: first digit is productivity, second is shade."}
...
```{r XX32F1234, fig.height=7.5, fig.cap="\\label{fig:XX32}Four different simulations (blue) for 4 farm types in Guatemala. Farm type codes ranging from 1 = very low to 4 = high: first digit is productivity, second is shade."}
  par( mfrow=c(5,4), mar=c(1,2,1,1) )
