...
- Have 'nt' different tree pruning- and thinning calendars.
- But ignore species-specific fertlisation (such as at the base of tree stems)?
...
- Make all tree parameters species-scpecific so they can all be calibrated.
    - Currently only 7 of the 36 tree parameters can be assiged tree-sp. specific values and that is done in 'set_params.f90' (i.e. within the FORTRAN-code, not R-code) which precludes BC.
