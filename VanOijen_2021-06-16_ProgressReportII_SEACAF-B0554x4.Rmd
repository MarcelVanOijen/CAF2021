...
ATTENTION: PARAMETER SETTINGS

- We set soil carbon turnover rates at Turrialba twice as high as at Masatepe.
- RNLEACH	is set at 0.5 for both sites.
...
```{r, out.width="100%", fig.cap="\\label{fig:TurrialbaMasatepeYields2}Yields using the MAP parameter vector from Bayesian calibration, but with some additional parameter change(s)."}
  ...
  # set_parNames  <- c( "FHARVBT(1)", "FHARVBT(2)", "FHARVBT(3)" )
  # set_parValues <- c(  1,            1,            1           )
  # set_parNames  <- c( "TCLITT", "TCSOMF", "TCSOMS" )
  # set_parValues <- c(  300    ,  6000   ,  15000   )
