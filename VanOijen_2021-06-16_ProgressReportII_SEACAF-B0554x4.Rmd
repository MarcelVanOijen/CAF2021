...
Fig. \ref{fig:averageYields} shows observed variation of coffee production in the 14 simulated treatments of the Masatepe experiment.

```{r averageYields, fig.height=3.5, fig.cap="\\label{fig:averageYields}Average annual yields for the 14 treatments in Masatepe: simulations vs. observations."}
# After running a BC
  load('BC_17_27.RData')
  source('BC/BC_averageYields_Masatepe_01-14.R')
```
