...
```{r, include=FALSE}
  file_BC_Turrialba.RData           <- 'BC_Turrialba_06_02.RData'
  file_BC_Masatepe.RData            <- 'BC_Masatepe_17_36.RData'
  file_BC_Turrialba_Masatepe.RData  <- 'BC_Turrialba_Masatepe_08_43.RData'
```
...
Unless otherwise indicated, all results shown in this section are for the Maximum A Posteriori (MAP) paramater vector from one multi-site calibration of CAF2021 on data from Turrialba and Masatepe.

Fig. \ref{fig:YieldsObsSimTurrialbaMasatepe} shows observed and simulated variation of coffee production in the 32 simulated treatments (18 from Turrialba, 14 from Masatepe).

```{r, out.width="100%", fig.cap="\\label{fig:YieldsObsSimTurrialbaMasatepe}Simulated vs. observed annual yields for the 32 treatments in Turrialba and Masatepe. Left: all recorded and simulated yields. Right: average yield for each of the treatments."}
  load( file_BC_Turrialba_Masatepe.RData )
...
```{r, out.width="100%", fig.cap="\\label{fig:YieldsObsSimTurrialba}Simulated vs. observed annual yields for the 18 treatments in Turrialba. Left: all recorded and simulated yields. Right: average yield for each of the treatments."}
