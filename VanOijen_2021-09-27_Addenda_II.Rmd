...
```{r XX31F1234, fig.height=7.5, fig.cap="\\label{fig:XX31F1234}Four different simulations (blue) for 4 farm types in Costa Rica. Farm type codes ranging from 1 = very low to 4 = high: first digit is productivity, second is shade."}
  ...
  ysim    <- "Shade_fb"
  ysim1.13 <- oF1_C[ if_C.type12, ysim ] ; ysim1.24 <- oF1_C[ if_C.type24, ysim ]
  ysim1.33 <- oF1_C[ if_C.type32, ysim ] ; ysim1.43 <- oF1_C[ if_C.type43, ysim ]
  ysim2.13 <- oF2_C[ if_C.type12, ysim ] ; ysim2.24 <- oF2_C[ if_C.type24, ysim ]
  ysim2.33 <- oF2_C[ if_C.type32, ysim ] ; ysim2.43 <- oF2_C[ if_C.type43, ysim ]
  ysim3.13 <- oF3_C[ if_C.type12, ysim ] ; ysim3.24 <- oF3_C[ if_C.type24, ysim ]
  ysim3.33 <- oF3_C[ if_C.type32, ysim ] ; ysim3.43 <- oF3_C[ if_C.type43, ysim ]
  ysim4.13 <- oF4_C[ if_C.type12, ysim ] ; ysim4.24 <- oF4_C[ if_C.type24, ysim ]
  ysim4.33 <- oF4_C[ if_C.type32, ysim ] ; ysim4.43 <- oF4_C[ if_C.type43, ysim ]
