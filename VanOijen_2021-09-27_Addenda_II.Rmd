...
```{r list_outF_C_SA, eval=T, cache=F}
...
```{r list_outF_G_SA, eval=T, cache=F}
...
```{r XX32sim, fig.height=7.5, fig.cap="\\label{fig:XX32sim}Simulations for 4 farm types in Guatemala. Farm type codes ranging from 1 = very low to 4 = high: first digit is productivity, second is shade."}
  par( mfrow=c(3,3), mar=c(4,4,3,1) )
